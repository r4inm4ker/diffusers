...
class StableDiffusionXLControlNetPipeline(
    ...
    def __call__(
        ...
        if not output_type == "latent":
            ...
            control_image = self.vae.decode(latents / self.vae.config.scaling_factor, return_dict=False)[0]
        ...
        if not output_type == "latent":
            ...
            control_image = self.image_processor.postprocess(control_image, output_type=output_type)
